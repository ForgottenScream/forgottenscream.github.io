...
var $author$project$Main$footerView = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('© 2025 ForgottenScream')
				]))
		]));
...
var $author$project$Main$headerView = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Welcome to my portfolio!')
				])),
			A2(
			$elm$html$Html$h2,
			_List_Nil,
...
var $author$project$Main$mainView = A2(
	$elm$html$Html$main_,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('This is a mini side project that I am working on to showcase my other works, practice new skills, and develop a portfolio page on GitHub.')
				])),
			A2(
			$elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text('It will be a useful way to maintain a timeline and record the different projects and ideas I undertake, while showing (hopefully) linear progression of my knowledge and abilities.')
				]))
		]));
var $author$project$Main$view = A2(
	...
	_List_Nil,
	_List_fromArray(
		[$author$project$Main$headerView, $author$project$Main$mainView, $author$project$Main$footerView]));
